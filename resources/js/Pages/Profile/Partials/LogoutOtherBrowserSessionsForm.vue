    ...
    <ActionSection>
        ...
        <template #content>
            <div class="max-w-xl text-sm text-gray-600">
                Si es necesario, puedes cerrar sesión en todas las demás sesiones de tu navegador en todos tus dispositivos. Algunas de tus sesiones recientes se enumeran a continuación; sin embargo, es posible que esta lista no sea exhaustiva. Si crees que tu cuenta se ha visto comprometida, también debes actualizar tu contraseña.
            </div>
